...
Related: [PBIF & Adaptive Façade Kinematics](../facade/pbif_and_kinematics.md) — the digital twin's own decision layer and the kinematics solver the VEC's servo output ultimately maps onto.
